...
$uid='58d31a671a8c1'; //Any random unique number
...
$admin_pswd='vaibhav12345'; //backend password 
...
/* Custom driver */
$usertable='students'; //specifies the name of the table in which your user information is stored.
$row_username='NAME'; //specifies the name of the field in which the user's name/display name is stored.
$row_userid='ROLLNO'; //specifies the name of the field in which the user's id is stored (usually id or userid)


$avatar_table_name='students'; //specifies the table where avatar information is stored
$avatar_column_name='userimg'; //specifies the column name where the avatar url is stored
$avatar_userid='ROLLNO'; //specifies the userid  to the user to get the user's avatar
