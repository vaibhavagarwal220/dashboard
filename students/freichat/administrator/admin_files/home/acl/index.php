        ...
        <div class="box-content">
            <table class="table table-striped table-bordered" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                ...
                <tbody>
                    ...
                    <?php } ?>
                    <?php if($param->show_mobilechat_plugin == "enabled") { ?>
                    <tr>
                        <td class="classleft">Group chat</td>
                        <td><input type="checkbox" disabled value="unchecked" /></td>
                        <td><input type="checkbox" name="p_groupchat" value="checked" <?php $param->default_param(array("ACL", "groupchat", "user"), "allow", true); ?> /></td>
