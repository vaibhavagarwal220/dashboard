...
IF object_id('frei_rooms', 'U') is not null
	DROP TABLE "frei_webrtc";

IF object_id('frei_rooms', 'U') is not null
	DROP TABLE "frei_video_session";
...
IF object_id('frei_webrtc', 'U') is null
BEGIN
	CREATE TABLE [dbo].[frei_webrtc](
...
BEGIN
	...
	INSERT INTO "frei_config" ( "key", "cat", "subcat", "val") VALUES
			...
			( 'ACL', 'chat', 'guest', 'allow'),
                        ...
                        ('ACL', 'groupchat', 'user', 'allow'),
                        ('ACL', 'groupchat', 'guest', 'noallow');
