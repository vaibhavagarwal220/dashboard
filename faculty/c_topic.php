...
$cid=$_GET['cid'];
$uname=$_GET['uname'];
$sql = "INSERT INTO table_forum(forum_name,
                    forum_description,course_id)
				VALUES('".$forum_name."','".$forum_description."',".$cid.")
                ";
  ...
  {   
    ...
    header("Location:show_and_create_topics.php?cid=$cid&uname=$uname");
