<?php
    ...
    if(isset($_POST['change']))
    {
        ...
        if($choice=="accept")
        {
            $db->query("UPDATE projects set state =1 where id = '".$id."'");
            ...
            $db->query("UPDATE projects set state =0 where id = '".$id."'");
...
<center>
         ...
         <form action="issue_project.php" method="POST"> 
        ...
        <div class="col-md-4 col-md-offset-4" >
            ...
            <label for="type" style= "font-size: 100%" text-align= "center" ></label>
                                        ...
                                        <br><br>
                <input name="equipid"  id ="equipid" placeholder="Project ID" class="form-control" type="Text"><br>
        ...
        <form action="display_project.php" method="POST">
            <button name="display" value="display" class="btn btn-primary " type="submit">Running Projects</button>
        </form>
<br><br>
</center>         <!-- Main Text -->
<?php
...
$result=$db->query("SELECT * FROM projects where state=2 and club = '".$club."' ");
