...
$club="";
    if(isset($_POST['eid']) and isset($_POST['delete']))
    {
        $removeid = $_POST['eid'];
        $delete = $_POST['delete'];
        $db->query("UPDATE room SET state=0 where requestid='".$removeid."' ");    
         $db->query("UPDATE room set bookdate = NULL where requestid = '".$removeid."'");
        $db->query("UPDATE room set booktime = NULL where requestid = '".$removeid."'");
        $db->query("UPDATE room set booktime = NULL where requestid = '".$removeid."'");
    }
/*$club="";
echo "<br>";
                        ...
                        <div class="col-md-11 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="admin_welcome.php" >Profile</a>
                                    </li>
                                   <li>
...
<form action="display_room.php" method="POST"> 
        ...
        <div class="col-md-4 col-md-offset-4" >
            ...
            <label for="type" style= "font-size: 100%" text-align= "center" ></label>
                ...
                <input name="eid"  id ="eid" placeholder="ID of finished booking" class="form-control" type="Text"><br>
                  <button name="delete" value="delete" class="btn btn-primary " type="submit">Delete Record</button>
            </div>
             </div>
        </div>
        </div>
...
$result=$db->query("SELECT * FROM room where state=1  ");
