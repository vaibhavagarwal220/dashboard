...
$result1=$db->query("UPDATE $type SET name = '".$name."' , phoneno = '".$phone."', emailid = '".$email."', password = '".$password."'  where rollno='".$_SESSION['rollno']."' ");
?>
<!-- === BEGIN HEADER === -->
<!DOCTYPE html>
...
<!-- === BEGIN FOOTER === -->
            ...
            <script type="text/javascript" src="assets/j
                                        <span class="fa-gears ">Your projects</a></span>
                                      <ul>
                                            <li>
