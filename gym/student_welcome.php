            ...
            <div id="icons" class="bottom-border-shadow">
                <div class="container background-grey bottom-border">
                    <div class="row padding-vert-60">
                        ...
                        <div class="col-md-4 text-center">
                        <a href="form_equip.html">
                            <i class="fa-wrench fa-4x color-primary animate fadeIn"></i>
                            <h2 class="padding-top-10 animate fadeIn">Issue Equipment</a></h2>
                            
                        </div>
                        <div class="col-md-4 text-center"><a href="form_pro.html">
                            <i class="fa-gears fa-4x color-primary animate fadeIn"></i>
                            <h2 class="padding-top-10 animate fadeIn">Start a project</a></h2>
