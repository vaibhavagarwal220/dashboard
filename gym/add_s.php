                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <form class="login-page">
                                    <div class="login-header margin-bottom-30">
                                        <h2>Enter details for new student.</h2>
                                    </div>
                                    ...
                                    <div class="input-group margin-bottom-20">
                                        <input name="rollno" id = "pass" placeholder="Roll No" class="form-control" type="text" required> 
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <input name="phno" id = "pass" placeholder="Phone No" class="form-control" type="text" required> 
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <input name="email" id = "pass" placeholder="Email-ID" class="form-control" type="text" required> 
                                    </div>
                                    <div class="input-group margin-bottom-20">
