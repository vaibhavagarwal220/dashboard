...
$result1=$db->query("SELECT * FROM coordinator where rollno='".$_SESSION['rollno']."' ");
    if(isset($_POST['eid']) and isset($_POST['delete']))
    {
        $removeid = $_POST['eid'];
        $delete = $_POST['delete'];
        $db->query("UPDATE equipment SET state=0 where equipid='".$removeid."' ");    
         $db->query("UPDATE equipment set issuedate = NULL where equipid = '".$removeid."'");
        $db->query("UPDATE equipment set returndate = NULL where equipid = '".$removeid."'");
    }
$club="";
echo "<br>";
...
<form action="display_equip.php" method="POST"> 
        ...
        <div class="col-md-4 col-md-offset-4" >
            ...
            <label for="type" style= "font-size: 100%" text-align= "center" ></label>
                ...
                <input name="eid"  id ="eid" placeholder="ID of completed project" class="form-control" type="Text"><br>
...
$result=$db->query("SELECT * FROM equipment where state=1 and club = '".$club."' ");
