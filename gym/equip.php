...
$q="SELECT equipid,equipname,state FROM equipment WHERE equipid LIKE '$eqid%' ";
//echo $q;
$result=$db->query($q) ;
 ...
 if($c<$quantity)
{
    ...
    ?>
    <p>Equipment not available in requested quantity</P>
...
else
{
    ...
    $w="UPDATE equipment SET state = 2 WHERE ((equipid LIKE '$eqid%') AND (state = 0)) ";
    while($c>0):
    $upd=$db->query($w) ;
    $c--;
    endwhile;        
    ...
    <div>                           
    <p>Equipment available. Requested.</p>
    <br><br><br><br><br><br><br><br><br><br><br><br><br>
    </div></b></h4>
    <?php
}
