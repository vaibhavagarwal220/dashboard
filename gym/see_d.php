...
<center>
        ...
        <div class="col-md-4 col-md-offset-4 " >
         ...
         <!--<form action="add_s.php" method="POST">-->
           ...
           <a href="see_s.php">
                  <button name="change" value="change" class="btn btn-primary " type="submit">Student</button>
            </a>
            </div>

             <form action="see_c.php" method="POST">
                <div class="panel-body">
           
                  <button name="change" value="change" class="btn btn-primary " type="submit">Coordinator</button>
            </div>
             </form>
             <form action="see_a.php" method="POST">
                <div class="panel-body">
           
                  <button name="change" value="change" class="btn btn-primary " type="submit">Admin</button>
            </div>
             </form>
