<?php
    ...
    if(isset($_POST['change']))
    {
        ...
        if($choice=="accept")
        {
            $db->query("UPDATE room set state =1 where requestid = '".$id."'");

        }
        else
            $db->query("UPDATE room set state =0 where requestid = '".$id."'");

    }
    $result1=$db->query("SELECT * FROM  room where state=2 ");
...
<center>
        ...
        <div class="col-md-4 col-md-offset-4" >
            <div class="panel panel-default">
                 <div class="panel-heading">
                     <h3 class="panel-title"><strong> Room Management</strong></h3>
                </div>
            ...
            <label for="type" style= "font-size: 100%" text-align= "center" ></label>
                                        ...
                                        <br><br>
                <input name="equipid"  id ="equipid" placeholder="Request Id" class="form-control" type="Text"><br>
        ...
        <form action="display_room.php" method="POST">
            <button name="display" value="display" class="btn btn-primary " type="submit">Currently Booked</button>
        </form>
<br><br>
</center>         <!-- Main Text -->
<?php
...
$result=$db->query("SELECT * FROM room where state=2  ");
