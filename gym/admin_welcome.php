                ...
                <div class="container background-grey bottom-border">
                    <div class="row padding-vert-60">
                        ...
                        <a href="br1.php">
                            ...
                            <h2 class="padding-top-10 animate fadeIn">Confirm booking room request</h2></a>
                        </div>
                        <div class="col-md-4 text-center">
                        <a href="see_d.php">
                            <i class="fa-search fa-4x color-primary animate fadeIn"></i>
                            <h2 class="padding-top-10 animate fadeIn">See database</h2></a>
                        </div>
                        <div class="col-md-4 text-center">
                        <a href="conf_p.php">
                            <i class="fa-folder-open fa-4x color-primary animate fadeIn"></i>
                            <h2 class="padding-top-10 animate fadeIn">Modify database</h2></a>
                        </div>
                        <!--End Icons--> 
                    </div>
                </div>
